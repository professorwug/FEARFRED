# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/00c_Manifolds.ipynb.
...
# %% ../../nbs/00c_Manifolds.ipynb 6
def add_noise(X, sigma=0):
    return X + np.random.normal(0, sigma, X.shape)

# %% ../../nbs/00c_Manifolds.ipynb 8
